...
public class ChangeOperationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initFields();
        textViewTitle.setText("Update operation");
    ...
    private void loadData(long operationID) {
        ...
        try {
            ...
            editTextSum.setText(formattedSum);
            editTextComment.setText(operation.getComment());
    ...
    public void saveOperation(View view) {
        ...
        try (DatabaseHelper dbHelper = new DatabaseHelper(this);
            ...
            db.update(DatabaseHelper.TABLE_OPERATIONS, values, selection, selectionArgs);
